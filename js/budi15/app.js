...
<div class="input-group mb-4">
  ...
  <div class="card-body text-center">
    <p style="border: dashed 2px #ee3f10; padding: 15px; margin: 10; text-align: left; line-height: 23px; color: #faf8f7; font-size: 18px">Support admin dengan cara klik iklan dan share https://budy.hartawan.workers.dev terimakasih.</p>
</div>
  <br></div>`;
                }
            } catch (err) {
...
<button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip"> Salin </span> </button>
  <div class="card-body text-center">
    <p style="border: dashed 2px #ee3f10; padding: 15px; margin: 10; text-align: left; line-height: 23px; color: #faf8f7; font-size: 18px">Support admin dengan cara klik iklan dan share kolom link diatas terimakasih.</p>
</div>
<br>
  </div>
  </div>
...
<div class="input-group mb-4">
  ...
  <button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip"> Salin </span> </button></div><br>
    ...
    <div class="card-body text-center">
    <p style="border: dashed 2px #ee3f10; padding: 15px; margin: 10; text-align: left; line-height: 23px; color: #faf8f7; font-size: 18px">Bantu admin dengan cara klik iklan dan share https://budy.hartawan.workers.dev terimakasih.</p>
</div>
</div>
  `;
            } catch (err) {
