...
<div class="btn-group text-center">
    ...
    <a href="${url}" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/tw.png"; height: 24px>>f</a>
    <a href="${url}" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/fb.png"; height: 24px>>f</a>
    <a href="${url}" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/wa.png"; height: 24px>f</a>
<a href="https://trakteer.id/budi-hartawan-cgywh/tip" target="_blank"><img id="wse-buttons-preview" src="https://cdn.trakteer.id/images/embed/trbtn-red-1.png" style="border: 0px none; height: 24px;" alt="Trakteer Saya" height="24"></a>
</div>
<br>
  </div>
  </div>
