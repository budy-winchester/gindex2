...
<div class="btn-group text-center">
    <a href="${url}" type="text" class="btn btn-primary">Share: </a>
    <a href="${url}" type="button" class="btn btn-primary"><i class="fa-phone-square"></i></a>
    <a href="${url}" type="button" class="btn btn-primary"><i class="fa-twitter"></i></a>
    <a href="${url}" type="button" class="btn btn-primary"><i class="fa-facebook"></i></a>
    <script type='text/javascript' src='https://cdn.trakteer.id/js/embed/trbtn.min.js'></script><script type='text/javascript'>(function(){var trbtnId=trbtn.init('Support Admin','#be1e2d','https://trakteer.id/budi-hartawan-cgywh/tip','https://trakteer.id/images/mix/ice-cream.png','24');trbtn.draw(trbtnId);})();</script>
    </div>
<br>
  </div>
  </div>
