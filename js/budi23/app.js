...
<div class="btn-group text-center">
    ...
    <a href="${url}" type="text" class="text-center"><i class="fa-phone-square">f</i></a>
    <a href="${url}" type="text" class="text-center"><i class="fa-twitter"></i>f</a>
    <a href="${url}" type="text" class="text-center"><i class="fa-facebook"></i>f</a>
