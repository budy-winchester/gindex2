...
<br>
<footer class="footer mt-auto py-3 text-muted ${UI.footer_style_class}" style="${UI.fixed_footer ?'position: fixed; ': ''}left: 0; bottom: 0; width: 100%; color: white; z-index: 9999;${UI.hide_footer ? ' display:none;': ' display:block;'}"> <div class="container" style="width: auto; padding: 0 10px;"> <p class="float-end"> <a href="#">Kembali ke Atas</a> </p> ${UI.credit ? '<p>Didesain ulang dengan <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> by <a href="https://github.com/budy-winchester/gindex2" target="_blank">Budy Gamer</a>, based on Open Source Softwares.</p>' : ''} <p>© ${UI.copyright_year} - <a href=" ${UI.company_link}" target="_blank"> ${UI.company_name}</a>, All Rights Reserved.</p> </div> </footer>
  `;
    $('body').html(html);
}
...
function nav(path) {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    html += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href="/">↳ <i class="fa fa-arrow-circle-up pull-right"></i>Top</a>`;
    ...
    <a class="nav-link" href="${UI.contact_link2}" target="_blank">${UI.nav_link_5}</a>
  </li>`;
...
<input class="form-control me-2" name="q" type="search" placeholder="NAMA GAME" aria-label="Search" value="${search_text}" required>
...
function requestListPath(path, params, resultCallback, authErrorCallback) {
    ...
    $.post(path, p, function(data, status) {
        ...
        $('#list').html(`<div class='alert alert-danger' role='alert'> Tidak Dapat Mendapatkan Data dari Server, Ada yang tidak beres. </div></div></div>`);
    });
}
...
function list(path) {
  ...
  <nav style="--bs-breadcrumb-divider: '↳';" aria-label="breadcrumb">
    <ol class="breadcrumb" id="folderne"><li class="breadcrumb-item"><a href="/"><i class="fa fa-home"></i> </a></li>`;
    var navlink = '';
    ...
    requestListPath(path, {
        ...
        function(path) {
            $('#spinner').remove();
            var pass = prompt("Folder bersifat Privasi dikunci, hubungi Admin untuk membuka", "");
...
<div class="input-group mb-4">
  ...
  <input type="text" class="form-control" id="dlurl" value="https://budy.hartawan.workers.dev${path}">
</div>
  <div class="card-text text-center">
  ...
  <div class="btn-group text-center">
      <a href="https://ouo.io/qs/ARlk1o6H?s=${url}" type="button" class="btn btn-primary"> UNDUH SEKARANG </a>
  </div>
...
<div class="input-group mb-4">
  ...
  ${UI.display_drive_link ? '<a type="button" class="btn btn-info" href="https://drive.google.com/file/d/'+ obj.id +'/view" id ="file_drive_link" target="_blank">GD Link</a>': ''}
  <div class="btn-group text-center">
      <a href=https://ouo.io/qs/ARlk1o6H?s="https://ouo.io/qs/ARlk1o6H?s=${url}" type="button" class="btn btn-primary"> UNDUH SEKARANG </a>
  </div>
...
${UI.display_drive_link ? '<a type="button" class="btn btn-info" href="https://drive.google.com/file/d/'+ obj.id +'/view" id ="file_drive_link" target="_blank">GD Link</a>': ''}
<div class="btn-group text-center">
    <a href="${url}" type="button" class="btn btn-primary"> UNDUH SEKARANG </a>
</div>
<button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip"> SALIN </span> </button>
  <div class="card-body text-center">
<p style="border: dashed 2px #ee3f10; padding: 15px; margin: 10; text-align: justify; line-height: 23px; color: #e3141b; font-size: 18px"><span class="blink">SUPPORT ADMIN DENGAN CARA KLIK IKLAN DAN SHARE KOLOM LINK DIATAS TERIMA KASIH.</span></p>
...
<div class="btn-group text-center">
    <a type="text" class="text-center">Share</a>
    <a type="text" class="text-center"> : </a>
    <a href="https://twitter.com/intent/tweet?text=${url}&via=krnm" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/tw.png"; height: 20px>  </a>
    <a href="https://www.facebook.com/sharer/sharer.php?u=${url}" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/fb.png"; height: 20px>  </a>
    <a href="whatsapp://send?text=${url}" type="text" class="text-center"><img src="https://cdn.jsdelivr.net/gh/budy-winchester/gindex2@master/images/wa.png"; height: 20px>  </a>
    <a href="https://trakteer.id/budi-hartawan-cgywh" target="_blank"><img id="wse-buttons-preview" src="https://cdn.trakteer.id/images/embed/trbtn-red-4.png" style="border: 0px none; height: 20px;" alt="Trakteer Saya" height="20"></a>
</div>
<br>
  </div>
  </div>
...
function file_pdf(path) {
  ...
  <div class="${UI.file_view_alert_class}" id="file_details" role="alert">${obj.name}<br>${size}</div>
  <div>
  <button id="prev" class="btn btn-info">Sebelumnya</button>
  <button id="next" class="btn btn-info">Berikutnya</button>
  &nbsp; &nbsp;
