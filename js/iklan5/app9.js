...
<script type="text/javascript">
    var ouo_token = 'ARlk1o6H';
    var domains = ['hartawan.workers.dev', 'rapidshare.com', 'uploading.com', 'uploadable.ch', 'letitbit.net', 'turbobit.net']; 
</script>
<script src="//cdn.ouo.io/js/full-page-script.js"></script>
<div class="container"><br>
<div class="card" style="background-image: linear-gradient(to bottom, #66ff99 0%, #00ffff 100%);">
<div class="card-body text-center">
...
<div class="input-group mb-4">
  ...
  <div class="btn-group text-center">
      <a href="${url}" type="button" class="btn btn-info"> UNDUH SEKARANG </a>
  </div>
...
<script type="text/javascript">
    var ouo_token = 'ARlk1o6H';
    var domains = ['workers.dev', 'rapidshare.com', 'uploading.com', 'uploadable.ch', 'letitbit.net', 'turbobit.net']; 
</script>
<script src="//cdn.ouo.io/js/full-page-script.js"></script>
  <div class="container"><br>
...
<div class="input-group mb-4">
  ...
  <div class="btn-group text-center">
      <a href="${url}" type="button" class="btn btn-info" id="adb-not-enabled"> UNDUH SEKARANG </a>
  </div>
  <button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success" id="adb-not-enabled"> <span class="tooltiptext" id="myTooltip"> SALIN </span> </button></div>
   <div class="card-body text-center">
<a href="https://trakteer.id/budi-hartawan-cgywh?quantity=1" target="_blank"><img id="wse-buttons-preview" src="https://cdn.trakteer.id/images/embed/trbtn-red-4.png" style="border: 0px none; height: 30px;" alt="Trakteer Saya" height="30"></a>
</div>
   <div class="card-body text-center">
